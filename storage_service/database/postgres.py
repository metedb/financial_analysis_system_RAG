...
### financial statements table format to store in postgresql
...
async def save_financials(financial_data):
    """Save financial statements to PostgreSQL"""
    async with AsyncSessionLocal() as session:
        try:
            logger.info(f"Processing {len(financial_data.data)} financial records")
